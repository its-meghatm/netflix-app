...
import 'package:netflix/src/presentation/screens/games_screen.dart';
import 'package:netflix/src/presentation/screens/home_screen.dart';
import 'package:netflix/src/presentation/screens/news_hots_screen.dart';
...
class MainHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ValueListenableBuilder(valueListenable: indexChange,
